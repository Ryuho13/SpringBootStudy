            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Q&A 답글 작성</h1>
                    </div>
                                ...
                                <div class="card-body">
                                    <form action="<c:url value='/qna/reply'/>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="boardTitle" name="boardTitle" value="[RE] ${dto.boardTitle}" required>
                                        </div>
                                        <div class="form-group">
